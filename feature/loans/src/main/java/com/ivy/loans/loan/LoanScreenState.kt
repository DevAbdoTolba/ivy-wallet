...
data class LoanScreenState(
    ...
    val itemizeSheetData: ItemizeSheetData? = null,
)

/** Shown right after a loan is created to offer optional itemization. */
data class ItemizeSheetData(
    val loanId: UUID,
    val loanName: String,
    val loanAmount: Double,
    val currencyCode: String,
    val loanColorArgb: Int,
)